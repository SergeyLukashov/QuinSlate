using Jott.AssetGenerator.Catalog;
using Jott.AssetGenerator.Imaging;
using System;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;

namespace Jott.AssetGenerator;
...
internal static class Program
{
    ...
    {
        Console.WriteLine("Usage: Jott.AssetGenerator <input-image> [output-directory] [options]");
        Console.WriteLine();
